...
# --- Fonksiyon: JSON, BSON, CSV, Excel kaydet ---
def save_versions(data, prefix):
    # JSON
    with open(f"{prefix}.json", "w", encoding="utf-8") as f:
        json.dump(data, f, ensure_ascii=False, indent=4)
    # BSON
    with open(f"{prefix}.bson", "wb") as f:
...
# --- 2️⃣ Full veriler ---
save_versions(universiteler_full, "universiteler_full")
print("✅ Full veriler kaydedildi.")

# --- 3️⃣ Sadece üniversite adları ---
universiteler_names = [{"ad": u["ad"]} for u in universiteler_full]
save_versions(universiteler_names, "universiteler_names")
